...
if(!class_exists('element_gva_gmap')):
   class element_gva_gmap{
      ...
      ?>
         ...
         <script src="//maps.googleapis.com/maps/api/js?key=<?php print $google_api ?>&display=swap"></script>
         <script src="<?php print (base_path() . drupal_get_path('theme', 'ziston')) ?>/assets/vendor/gmap3.js"></script>
         <script src="<?php print (base_path() . drupal_get_path('theme', 'ziston')) ?>/assets/vendor/jquery.ui.map.min.js"></script>
