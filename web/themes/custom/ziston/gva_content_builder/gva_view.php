         ...
         $fields = array(
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'class'     => 'gsc_display_view change_value_admin width-1-2',
               ),
               array(
                  'id'        => 'style_text',
                  'type'      => 'select',
                  ...
                  'class'     => 'width-1-2',
                  'options'   => array(
                     'text-default'  => t('Text Default'),
                     'text-light'    => t('Text light'),
                  ),
                  'default'      => 'text-default',
                  'desc'         => t('May be available for each views')
               ),
               array(
                  'id'        => 'show_title',
                  'type'      => 'select',
                  ...
                  'options'   => array(
                     'hidden'       => t('Hidden'),
                     'title_view'   => t('Title View'),
                     'title_block'  => t('Title Block')
                   ),
                  'default'       => 'hidden',
                  'class'     => 'width-1-3',
               ),
               ...
               array(
                  ...
                  'title'     => t('Align title'),
                  'options'   => array(
                     'title-align-left'   => t('Align Left'),
                     'title-align-right'  => t('Align Right'),
                     'title-align-center' => t('Align Center')
                  ),
                  'class'     => 'width-1-3',
